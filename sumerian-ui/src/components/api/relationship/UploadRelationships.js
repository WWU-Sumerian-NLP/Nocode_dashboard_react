...
const UploadRelationship = (props) => {
    ...
    if(csvFile) {
        formData.append("path_to_relationship_csv", csvFile);
    }
    ...
    const handleSubmit = (e) => {
        ...
        async function fetchData() {
            ...
            const res = await axios.post(
                "http://localhost:8000/insertRelationship",
                formData,
                'mutlipart/form-data',
            );
...
export default UploadRelationship